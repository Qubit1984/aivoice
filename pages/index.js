        ...
        <div className="row">
          ...
          <div className="col-10 col-sm-11 p-0 m-0">
            ...
            >
              <h3>AI Voice</h3>
              <p>
                AI Voice is a NextJs/React web application where you can chat
                with AI chatbots, powered by ChatGPT from{" "}
                <a href="https://openai.com">OpenAI</a>.
              </p>
              <p>
                To use it, you need to obtain an OpenAI API key and add it to
                .env.local file in the root folder of the project, like this:
                <br />
